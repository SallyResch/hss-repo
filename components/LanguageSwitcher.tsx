      ...
      {isOpen && (
        <div className="absolute right-0 top-full w-32 bg-hss-yellow text-hss-scout-darkblue rounded-md shadow-lg overflow-hidden z-50">
          ...
          <button
            ...
            className={`block w-full text-left px-4 py-3 transition-all duration-300 hover:[text-shadow:0_0_0.6px_currentColor] ${
              locale === 'sv' ? '[text-shadow:0_0_0.6px_currentColor]' : ''}`}
          >
            Svenska
          </button>
          ...
          <button
            ...
            className={`block w-full text-left px-4 py-3 transition-all duration-300 hover:[text-shadow:0_0_0.6px_currentColor] ${
              locale === 'en' ? '[text-shadow:0_0_0.6px_currentColor]' : ''}`}
          >
            English
          </button>
